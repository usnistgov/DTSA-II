...
public class SimulationWizard
   ...
   enum VPGas {
      HELIUM("Helium") {
         ...
         public Gas toGas(double pressure) {
            return new Gas(new Element[] {
               Element.He
            }, new int[] {
               1
            }, pressure, 300.0, "Helium");
         }
      },
      OXYGEN("Oxygen") {
         @Override
   ...
   private final JWizardProgressPanel<ISpectrumData[]> mProgress = new JWizardProgressPanel<ISpectrumData[]>(this, "Computing the requested spectra...", mThread);
   private Session mSession;

   private class SimulationThread
      extends
      SwingWorker<ISpectrumData[], Integer> {
      ...
      public String asHTML() {
         ...
         switch(mMode) {
            ...
            case MCCube:
               ...
               break;
            case MCFilm:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a thin film sample</td></tr>");
               break;
            case MCInclusion:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of an inclusion</td></tr>");
               break;
            case MCSphere:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a spherical sample</td></tr>");
               break;
            case MCInterface:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a junction between two materials</td></tr>");
            case MCCylinderOnSide:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a cylinder on its side</td></tr>");
               break;
            case MCCylinderOnEnd:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a cylinder on its base</td></tr>");
               break;
            case MCHemisphere:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a hemispherical cap</td></tr>");
               break;
            case MCRectangularPrism:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a rectangular block</td></tr>");
               break;
            case MCSquarePyramid:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a pyramid with a square base</td></tr>");
               break;
            case MCTriangularPrism:
               sb.append("<tr><th align=right>Simulation mode</th><td>Monte Carlo model of a triangular prism</td></tr>");
               break;
            default:
               break;
         }
            ...
            case MCInterface:
               if(mSubstrateMaterial.equals(Material.Null))
                  ...
                  sb.append("<tr><th align=right>Secondary material</th><td>" + mSubstrateMaterial.toHTMLTable()
                        + "</td></tr>");
               sb.append("<tr><th align=right>Primary Material</th><td>" + mObjectMaterial.toHTMLTable() + "</td></tr>");
               break;
            default:
               break;
         ...
         switch(mMode) {
            ...
            case MCBulk:
               break;
            case MCCube:
               sb.append("<tr><th align=right>Edge length</th><td>" + nf3.format(mScale * 1.0e6) + " \u00B5m</td></tr>");
               break;
            case MCFilm:
               sb.append("<tr><th align=right>Film thickness</th><td>" + nf3.format(mScale * 1.0e6) + " \u00B5m</td></tr>");
               break;
            case MCInclusion:
               sb.append("<tr><th align=right>Inclusion width</th><td>" + nf3.format(mScale * 1.0e6) + " \u00B5m</td></tr>");
               sb.append("<tr><th align=right>Inclusion thickness</th><td>" + nf3.format(mScale2 * 1.0e6)
                     + " \u00B5m</td></tr>");
               break;
            case MCSphere:
            case MCHemisphere:
               sb.append("<tr><th align=right>Sphere diameter</th><td>" + nf3.format(mScale * 1.0e6) + " \u00B5m</td></tr>");
               break;
            case MCInterface:
            ...
            case MCRectangularPrism:
               ...
               sb.append("<tr><th align=right>Thickness</th><td>" + nf3.format(mScale2 * 1.0e6) + " \u00B5m</td></tr>");
               break;
            case MCSquarePyramid:
         ...
         sb.append("<tr><th align=right>Sample rotation</th><td>" + nf1.format(Math.toDegrees(mRotate)) + "\u00B0</td></tr>");
         sb.append("<tr><th align=right>Sample tilt</th><td>" + nf1.format(Math.toDegrees(mIncidentAngle))
               + "\u00B0</td></tr>");
         sb.append("<tr><th align=right>Beam energy</th><td>" + nf1.format(FromSI.keV(mBeamEnergy)) + " keV</td></tr>");
         sb.append("<tr><th align=right>Probe dose</th><td>" + nf1.format(mProbeDose / ToSI.NANO) + " nA\u00B7s</td></tr>");
         ...
         sb.append("<tr><th align=right>Calibration</th><td>" + mDetector.getCalibration().toString() + " </td></tr>");
         ...
         if(mEnableVP)
            sb.append(nf3.format(1000.0 * mVPPathLength) + " mm of " + mVPGas + " at " + nf1.format(mVPPressure) + " pascal");
         else
         ...
         if(mXRayAccumulator3 != null) {
            if(mXRayAccumulator3CF != null) {
               sb.append("<tr><th>Comparing " + mXRayAccumulator3.toString() + " to <br/>" + mXRayAccumulator3CF.toString()
                     + "</th><td>");
               sb.append(mXRayAccumulator3.compareAsHTML(mXRayAccumulator3CF));
               sb.append("</td></tr>");
            }
            if(mXRayAccumulator3BF != null) {
               sb.append("<tr><th>Comparing " + mXRayAccumulator3.toString() + " to <br/>" + mXRayAccumulator3BF.toString()
                     + "</th><td>");
         ...
         if(mVoxelatedDetector != null) {
            ...
            sb.append("<table>");
            sb.append("<tr><th>Ionization<br/>Edge</th><th>Ionization<br/>Energy<br/>(keV)<th>F(50 &#37;)<br/>Depth<br/>(&micro;m)</th><th>F(90 &#37;)<br/>Depth<br/>(&micro;m)</th><th>F(99.9 &#37;)<br/>Depth<br/>(&micro;m)</th><th>F(50 &#37;)<br/>Volume<br/>(&micro;m)<sup>3</sup></th><th>F(90 &#37;)<br/>Volume<br/>(&micro;m)<sup>3</sup></th><th>F(99.9 &#37;)<br/>Volume<br/>(&micro;m)<sup>3</sup></th></tr>\n");
      ...
      @Override
      protected ISpectrumData[] doInBackground()
            throws Exception {
         mVrmlFile = null;
               ...
               switch(mMode) {
                  ...
                  case MCCube: {
                     {
                        ...
                        final double rObj = ElectronRange.KanayaAndOkayama1972.computeMeters(mObjectMaterial, mBeamEnergy);
                        sc = Math.min(mScale, rObj) + Math.max((1.1 - (mScale / rObj)) * rSub, rObj / 10.0);
                     }
                     final double[] center = Math2.plus(origin, Math2.z3(mScale / 2.0));
                     final MonteCarloSS.Shape cube = MultiPlaneShape.createBlock(Math2.v3(mScale, mScale, mScale), center, 0, 0, 0);
                     ...
                     if(!mSubstrateMaterial.equals(Material.Null)) {
                        ...
                        final double[] dims = Math2.v3(dim, dim, dim);
                        final MonteCarloSS.Shape shape = MultiPlaneShape.createBlock(dims, Math2.plus(center, Math2.z3((mScale
                              + dim) / 2.0)), 0.0, 0.0, 0.0);
                        mc.addSubRegion(chamber, mSubstrateMaterial, shape);
                     }
                     specDesc = specDesc + " a " + nf.format(1.0e6 * mScale) + " \u00B5m cube of " + mObjectMaterial.toString()
                  ...
                  case MCFilm: {
                     ...
                     }
                     {
                        ...
                        final MonteCarloSS.Shape film = MultiPlaneShape.createBlock(dims, Math2.plus(origin, Math2.z3(0.5
                              * mScale)), 0.0, 0.0, 0.0);
                     ...
                     if(mSubstrateMaterial.equals(Material.Null))
                        ...
                        {
                           final double[] dims = Math2.v3(dim, dim, dim);
                           final MonteCarloSS.Shape shape = MultiPlaneShape.createBlock(dims, Math2.plus(origin, Math2.z3(mScale
                                 + 0.5 * dim)), 0.0, 0.0, 0.0);
                           mc.addSubRegion(chamber, mSubstrateMaterial, shape);
                        }
                        specDesc = specDesc + " a " + nf.format(1.0e6 * mScale) + " \u00B5m film of "
                  ...
                  case MCInclusion: {
                     ...
                     if(true) {
                        ...
                        if(!mSubstrateMaterial.equals(Material.Null)) {
                           final MonteCarloSS.Shape shape = MultiPlaneShape.createBlock(Math2.v3(dim, dim, dim), Math2.plus(origin, Math2.z3(0.5
                                 * dim)));
                        ...
                        final MonteCarloSS.Shape inclusion = MultiPlaneShape.createBlock(Math2.v3(mScale, mScale, mScale2), Math2.plus(origin, Math2.z3(so2)));
                        elms.addAll(mObjectMaterial.getElementSet());
                        mc.addSubRegion(region, mObjectMaterial, inclusion);
                     } else {
                        // Complex model using distinct objects
                        if(!mSubstrateMaterial.equals(Material.Null)) {
                           final double d1 = 0.5 * (dim - mScale);
                           final double d2 = 0.25 * (dim + mScale);
                           {
                              final double[] v3a = Math2.v3(dim, d1, mScale2);
                              final MonteCarloSS.Shape shape1 = MultiPlaneShape.createBlock(v3a, Math2.plus(origin, Math2.v3(0.0, d2, so2)));
                              mc.addSubRegion(chamber, mSubstrateMaterial, shape1);
                              final MonteCarloSS.Shape shape2 = MultiPlaneShape.createBlock(v3a, Math2.plus(origin, Math2.v3(0.0, -d2, so2)));
                              mc.addSubRegion(chamber, mSubstrateMaterial, shape2);
                           }
                           {
                              final double[] v3b = Math2.v3(d1, mScale, mScale2);
                              final MonteCarloSS.Shape shape3 = MultiPlaneShape.createBlock(v3b, Math2.plus(origin, Math2.v3(d2, 0.0, so2)));
                              mc.addSubRegion(chamber, mSubstrateMaterial, shape3);
                              final MonteCarloSS.Shape shape4 = MultiPlaneShape.createBlock(v3b, Math2.plus(origin, Math2.v3(-d2, 0.0, so2)));
                              mc.addSubRegion(chamber, mSubstrateMaterial, shape4);
                           }
                           final MonteCarloSS.Shape shape5 = MultiPlaneShape.createBlock(Math2.v3(dim, dim, dim
                                 - mScale2), Math2.plus(origin, Math2.z3(0.5 * (dim + mScale2))));
                           mc.addSubRegion(chamber, mSubstrateMaterial, shape5);
                           elms.addAll(mSubstrateMaterial.getElementSet());
                        }
                        final MonteCarloSS.Shape inclusion = MultiPlaneShape.createBlock(Math2.v3(mScale, mScale, mScale2), Math2.plus(origin, Math2.z3(0.5
                              * mScale2)));
                        elms.addAll(mObjectMaterial.getElementSet());
                        mc.addSubRegion(chamber, mObjectMaterial, inclusion);

                     }
                     specDesc = specDesc + " a " + nf.format(1.0e6 * mScale) + " \u00B5m wide, " + nf.format(1.0e6 * mScale2)
                           + " thick inclusion of " + mObjectMaterial.toString() + " in " + mSubstrateMaterial.toString();
                     if(mThread.mOverscan) {
                        final double[] over = overScanBox(1.1 * mScale, 1.1 * mScale, mRotate);
                        gun = new OverscanElectronGun(over[0], over[1]);
                        specDesc = specDesc + " (overscan)";
                  ...
                  case MCInterface: {
                     ...
                     if(!mObjectMaterial.equals(Material.Null)) {
                        elms.addAll(mObjectMaterial.getElementSet());
                        final double[] pos = Math2.v3(origin[0] - ((0.25 * dim) - mScale), origin[1], origin[2] + (0.5 * dim));
                        final MonteCarloSS.Shape shape = MultiPlaneShape.createBlock(dims, pos, 0, 0, 0);
                  ...
                  case MCCylinderOnSide: {
                     ...
                     final MonteCarloSS.Shape cylinder = new CylindricalShape(Math2.minus(center, halfLen), Math2.plus(center, halfLen), 0.5
                           * mScale);
                     ...
                     if(!mSubstrateMaterial.equals(Material.Null)) {
                        final double dim = Math.max(10.0 * mScale, 1.0e-2);
                        final double[] dims = Math2.v3(dim, dim, dim);
                        final MultiPlaneShape shape = MultiPlaneShape.createBlock(dims, Math2.plus(origin, Math2.z3(mScale
                              + 0.5 * dim)), 0.0, 0.0, 0.0);
                        mc.addSubRegion(chamber, mSubstrateMaterial, shape);
                        elms.addAll(mSubstrateMaterial.getElementSet());
                     }
                  ...
                  case MCCylinderOnEnd: {
                     ...
                     final MonteCarloSS.Shape cylinder = new CylindricalShape(origin, Math2.plus(origin, len), 0.5 * mScale);
                     mc.addSubRegion(chamber, mObjectMaterial, cylinder);
                     elms.addAll(mObjectMaterial.getElementSet());
                     final double dim = Math.max(10.0 * mScale, 1.0e-2);
                     final double[] dims = Math2.v3(dim, dim, dim);
                     final MonteCarloSS.Shape shape = MultiPlaneShape.createBlock(dims, Math2.plus(origin, Math2.z3(mScale2
                           + 0.5 * dim)), 0.0, 0.0, 0.0);
                     if(!mSubstrateMaterial.equals(Material.Null)) {
                        mc.addSubRegion(chamber, mSubstrateMaterial, shape);
                        elms.addAll(mSubstrateMaterial.getElementSet());
                     }
                     specDesc = specDesc + " a " + nf.format(1.0e6 * mScale) + " \u00B5m dia., " + nf.format(1.0e6 * mScale2)
                           + " \u00B5m high can of " + mObjectMaterial.toString() + " on " + mSubstrateMaterial.toString();
                     if(mThread.mOverscan) {
                        gun = new OverscanElectronGun(mScale, mScale);
                        specDesc = specDesc + " (overscan)";
                     }
                  ...
                  case MCHemisphere: {
                     ...
                     final double[] center = Math2.plus(origin, Math2.z3(0.5 * mScale));
                     final MonteCarloSS.Shape hemi = new ShapeDifference(new Sphere(center, 0.5
                           * mScale), MultiPlaneShape.createSubstrate(Math2.MINUS_Z_AXIS, center));
                     mc.addSubRegion(chamber, mObjectMaterial, hemi);
                     elms.addAll(mObjectMaterial.getElementSet());
                     if(!mSubstrateMaterial.equals(Material.Null)) {
                        final double dim = Math.max(10.0 * mScale, 1.0e-2);
                        final double[] dims = Math2.v3(dim, dim, dim);
                        final MonteCarloSS.Shape shape = MultiPlaneShape.createBlock(dims, Math2.plus(center, Math2.z3(0.5
                              * dim)), 0.0, 0.0, 0.0);
                        mc.addSubRegion(chamber, mSubstrateMaterial, shape);
                        elms.addAll(mSubstrateMaterial.getElementSet());
                     }
                  ...
                  case MCRectangularPrism: {
                     ...
                     final MonteCarloSS.Shape rectPrism = MultiPlaneShape.createBlock(Math2.v3(mScale, mScale, mScale2), center, 0.0, 0.0, 0.0);
                     ...
                     specDesc = specDesc + " a " + nf.format(1.0e6 * mScale) + " \u00B5m base, " + nf.format(1.0e6 * mScale2)
                           + " \u00B5m high block of " + mObjectMaterial.toString() + " on " + mSubstrateMaterial.toString();
                     if(mThread.mOverscan) {
                  ...
                  case MCSquarePyramid: {
                     ...
                     final MonteCarloSS.Shape sqPyramid = MultiPlaneShape.createSquarePyramid(origin, mScale, mScale2);
                     mc.addSubRegion(chamber, mObjectMaterial, sqPyramid);
                     elms.addAll(mObjectMaterial.getElementSet());
                     final double dim = Math.max(10.0 * mScale, 1.0e-2);
                     if(!mSubstrateMaterial.equals(Material.Null)) {
                        final MonteCarloSS.Shape shape = MultiPlaneShape.createBlock(Math2.v3(dim, dim, dim), Math2.plus(origin, Math2.z3(0.5
                              * dim + mScale2)), 0.0, 0.0, 0.0);
                        mc.addSubRegion(chamber, mSubstrateMaterial, shape);
                        elms.addAll(mSubstrateMaterial.getElementSet());
                     }
                     specDesc = specDesc + " a " + nf.format(1.0e6 * mScale) + " \u00B5m base, " + nf.format(1.0e6 * mScale2)
                           + " \u00B5m high square pyramid of " + mObjectMaterial.toString() + " on "
                           + mSubstrateMaterial.toString();
                     if(mThread.mOverscan) {
                        final double[] over = overScanBox(mScale, mScale, mRotate);
                        gun = new OverscanElectronGun(over[0], over[1]);
                        specDesc = specDesc + " (overscan)";
                  ...
                  case MCTriangularPrism: {
                     ...
                     final MultiPlaneShape rectPrism = MultiPlaneShape.createTriangularPrism(origin, mScale, mScale2);
                     mc.addSubRegion(chamber, mObjectMaterial, rectPrism);
                     elms.addAll(mObjectMaterial.getElementSet());
                     if(!mSubstrateMaterial.equals(Material.Null)) {
                        final double dim = Math.max(10.0 * mScale, 1.0e-2);
                     ...
                     specDesc = specDesc + " a " + nf.format(1.0e6 * mScale) + " \u00B5m base, " + nf.format(1.0e6 * mScale2)
                           + " \u00B5m length equilateral prism of " + mObjectMaterial.toString() + " on "
                           + mSubstrateMaterial.toString();
                     if(mThread.mOverscan) {
                        final double[] over = overScanBox(mScale, mScale2, mRotate);
                        gun = new OverscanElectronGun(over[0], over[1]);
               ...
               }
               {
                  ...
                  if((ctr != null) || (ctrFl != null)) {
                     ...
                     for(final Element elm : elms)
                        for(final String family : families) {
                           final XRayTransitionSet xrts = new XRayTransitionSet(elm, family, 0.0, ToSI.eV(200), mBeamEnergy
                                 / 1.1);
                           if(xrts.size() > 0)
                              xrtss.add(xrts);
                        }
                     ...
                     if(ctrFl != null) {
                        mXRayAccumulator3CF = new XRayAccumulator3(xrtss, "Characteristic Fluorescence", mProbeDose);
                        ctrFl.addXRayListener(mXRayAccumulator3CF);
                     }
                     if(brFl != null) {
                        mXRayAccumulator3BF = new XRayAccumulator3(xrtss, "Bremsstrahlung Fluorescence", mProbeDose);
                  ...
                  try {
                     ...
                     try (final FileWriter vrmlWr = new FileWriter(mVrmlFile)) {
                        ...
                        vrml.renderSample();
                        final double[] scaleOffset = Math2.v3(Math.max(1.2
                              * mScale, 2.0e-6), 0, -Math.max(1.2 * mScale, 2.0e-6));
                     ...
                     if(mEmissionImages3 != null) {
                        ...
                        if(writers.hasNext()) {
                           ...
                           for(final EmissionImage3 ei : mEmissionImages3) {
                              final File f = File.createTempFile("ei(" + ei.getTransition().toString() + ")_", ".png", base);
                     ...
                     /*
                      * Scale the spectrum from TRAJECTORIES electrons to the
                      * requested beam dose. Update the spectrum properties to
                      * reflect the simulated parameters.
                      */
                     ...
                     final SpectrumProperties specProps = spec.getProperties(), rawProps = rawSpec.getProperties();
                     ...
                     if(mMode == SimulationMode.MCBulk) {
                        specProps.setCompositionProperty(SpectrumProperties.StandardComposition, mSubstrateMaterial);
                        rawProps.setCompositionProperty(SpectrumProperties.StandardComposition, mSubstrateMaterial);
                     }
                     if((mMode == SimulationMode.MCFilm) && (mSubstrateMaterial.equals(Material.Null))) {
                        specProps.setCompositionProperty(SpectrumProperties.StandardComposition, mObjectMaterial);
                        specProps.setSampleShape(SpectrumProperties.SampleShape, new SampleShape.ThinFilm(sNorm, mScale));
                        specProps.setNumericProperty(SpectrumProperties.MassThickness, FromSI.cm(mScale)
                              * FromSI.gPerCC(mObjectMaterial.getDensity()) * 1.0e6); // &mu;g/cm<sup>2</sup>
                        rawProps.setCompositionProperty(SpectrumProperties.StandardComposition, mObjectMaterial);
                        rawProps.setSampleShape(SpectrumProperties.SampleShape, new SampleShape.ThinFilm(sNorm, mScale));
                        rawProps.setNumericProperty(SpectrumProperties.MassThickness, FromSI.cm(mScale)
                              * FromSI.gPerCC(mObjectMaterial.getDensity()) * 1.0e6); // &mu;g/cm<sup>2</sup>
                     }
                  }
      ...
      protected int computeTrajectoryCount() {
         ...
         final int trajectories = (thin
               ? (int) Math.round(ElectronRange.KanayaAndOkayama1972.computeMeters(mObjectMaterial, mBeamEnergy) / mScale) * 1000
               : 1000) * mExtraElectrons * (int) Math.round(Math2.bound(Math.sqrt(mProbeDose * FromSI.NANO / 60.0), 1.0, 16.0));
         return trajectories;
      }
   ...
   public class SimMode
      ...
      private final JRadioButton mMCFilm = new JRadioButton("Monte Carlo model of a film on a bulk, homogeneous substrate");
      private final JRadioButton mMCSphere = new JRadioButton("Monte Carlo model of a sphere on a bulk, homogeneous substrate");
      private final JRadioButton mMCCube = new JRadioButton("Monte Carlo model of a cube on a bulk, homogeneous substrate");
      private final JRadioButton mMCInclusion = new JRadioButton("Monte Carlo model of an inclusion in a bulk, homogeneous substrate");
      private final JRadioButton mMCInterface = new JRadioButton("Monte Carlo model of a beam near an interface");
      private final JRadioButton mMCSquarePyramid = new JRadioButton("Monte Carlo model of a pyramid with a square base");
      ...
      private void initialize() {
         final FormLayout fl = new FormLayout("5dlu, pref", "pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref, 1dlu, pref");
         ...
         mMCBulk.setToolTipText("<HTML>Generate a simulated spectrum for a flat, polished sample using a Monte Carlo model.");
         mMCFilm.setToolTipText("<HTML>Generate a simulated spectrum for a a flat, polished film over bulk sample using a Monte Carlo model.");
         mMCSphere.setToolTipText("<HTML>Generate a simulated spectrum for a spherical sample on a bulk substrate using a Monte Carlo model.");
         mMCCube.setToolTipText("<HTML>Generate a simulated spectrum for a cubic sample on a bulk substrate using a Monte Carlo model.");
         mMCInclusion.setToolTipText("<HTML>Generate a simulated spectrum for an inclusion on the surface of bulk sustrate using a Monte Carlo model.");
         mMCInterface.setToolTipText("<HTML>Generate a simulated spectrum for an interface between two materials using a Monte Carlo model.");
         mMCSquarePyramid.setToolTipText("<HTML>Generate a simulated spectrum for a pyramid with a square base.");
         mMCCylinderSide.setToolTipText("<HTML>Generate a simulated spectrum for a cylinder on its side (like a fiber.)");
         mMCCylinderTop.setToolTipText("<HTML>Generate a simulated spectrum for a cylider on its end (like a can.)");
         mMCHemisphere.setToolTipText("<HTML>Generate a simulated spectrum for a hemispherical cap resting on a substrate.");
         mMCRectangularPrism.setToolTipText("<HTML>Generate a simulated spectrum for a block with a square base and independent height.");
   ...
   public class SimConfiguration
      ...
      private void initialize() {
         ...
         if(dp != null) {
            ...
            if(xrd == null) {
               final DetectorCalibration dc = mSession.getSuitableCalibration(dp, new Date(System.currentTimeMillis()));
         ...
         // Initialize panel
         final FormLayout fl = new FormLayout("5dlu, right:pref, 5dlu, 50dlu, 3dlu, pref, 50dlu, 5dlu", "pref, 3dlu, pref, 3dlu, pref, 3dlu, pref, 3dlu, pref, 3dlu, pref, 3dlu, pref");
         ...
         final DefaultComboBoxModel<ElectronProbe> dcbm = new DefaultComboBoxModel<ElectronProbe>(mSession.getCurrentProbes().toArray(new ElectronProbe[0]));
         ...
         jComboBox_Calibration.setToolTipText("<HTML>Specify the performance characteristics of the chosen detector.");
         ...
         jTextField_ProbeDose.setToolTipText("<HTML>Specify the product of the probe current and live time as the probe dose.");
         ...
         jTextField_IncidentAngle.setToolTipText("<HTML>0&deg; represents the sample normal to the beam. Positive tilt<br />is towards azimuth 0&deg;. Negative tilt is towards azimuth 180&deg;");
      ...
      private void updateDetectors(EDSDetector det) {
         if(det != null) {
            ...
            final DefaultComboBoxModel<DetectorProperties> dcbm = new DefaultComboBoxModel<DetectorProperties>(dets.toArray(new DetectorProperties[0]));
      ...
      public boolean permitNext() {
         ...
         if(res)
            try {
               ...
               if((mThread.mIncidentAngle <= Math.toRadians(-90.0)) || (mThread.mIncidentAngle >= Math.toRadians(90.0))) {
      ...
      private void updateCalibrations(EDSDetector det) {
         ...
         if(jComboBox_Detector.getSelectedItem() instanceof DetectorProperties) {
            ...
            final DefaultComboBoxModel<DetectorCalibration> dcbm = new DefaultComboBoxModel<DetectorCalibration>(cals.toArray(new DetectorCalibration[0]));
   ...
   public class SimVP
      ...
      private void initialize() {
         ...
         final FormLayout fl = new FormLayout("5dlu, right:pref, 5dlu, 50dlu, 5dlu, left:pref, 5dlu", "pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref");
         final PanelBuilder pb = new PanelBuilder(fl);
         ...
         jTextField_Length.setToolTipText("The z-distance the electron travels in the gas before intersecting the optimal working distance.");
      ...
      @Override
      public boolean permitNext() {
         final double path = validateDouble(jTextField_Length, 0.001, 100.0, "Valid path lengths are between 0.001 mm and 100.0 mm.");
         final double pressure = validateDouble(jTextField_Pressure, 1.0e-7, 1.0e6, "Valid pressures are between 1.0e-7 and 1.0e6 pascal.");
      ...
      public void onHide() {
         ...
         final double pathLen = validateDouble(jTextField_Length, 0.001, 100.0, "Valid path lengths are between 0.001 mm and 100.0 mm.");
         if(!Double.isNaN(pathLen)) {
            userPref.putDouble("Path Length", pathLen);
            mThread.mVPPathLength = 0.001 * pathLen; // mm to meters
         }
         mThread.mVPPressure = validateDouble(jTextField_Pressure, 1.0e-7, 1.0e6, "Valid pressures are between 1.0e-7 and 1.0e6 pascal.");
   ...
   public class SimOther
      ...
      private void initialize() {
         final FormLayout fl = new FormLayout("5dlu, pref, 5dlu, 50dlu, 30dlu, pref, 5dlu", "pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref, 2dlu, pref");
         final PanelBuilder pb = new PanelBuilder(fl, this);
         final CellConstraints cc = new CellConstraints();
         pb.addSeparator("Noise parameters", cc.xyw(1, 1, 6));
         pb.add(jCheckBox_AddNoise, cc.xyw(2, 3, 5));
         jCheckBox_AddNoise.setToolTipText("<HTML>Check this box to add pseudo-randomly generate Poisson noise to the simulated spectrum.");
         ...
         jTextField_Count.setToolTipText("<HTML>This number of spectra will be created each with slightly different count statistics.");
         pb.add(jTextField_Count, cc.xy(4, 5));
         for(int i = 0; i < 5; ++i)
            if(i == 0)
               jComboBox_Extra.addItem("Run the default number of electron trajectories");
            else
               jComboBox_Extra.addItem("Run " + Integer.toString(1 << (2 * i)) + "\u00D7 as many electron trajectories");
         jComboBox_Extra.setToolTipText("<html>The simulation time scales linearly with the number of electron trajectories<br/>but the spectrum quality scales as the square root.  Running more electrons<br/>doesn't change the number of x-rays in the spectrum.");
   ...
   public class SimGeometry
      ...
      private void initialize() {
         ...
         try {
            final EPQXStream xs = EPQXStream.getInstance();
            mThread.mObjectMaterial = (Material) xs.fromXML(userPref.get("Object material", xs.toXML(MaterialFactory.createPureElement(Element.Cu))));
            mThread.mSubstrateMaterial = (Material) xs.fromXML(userPref.get("Substrate material", xs.toXML(MaterialFactory.createPureElement(Element.C))));
         }
         ...
         // Initialize panel
         final FormLayout fl = new FormLayout("5dlu, right:pref, 5dlu, 50dlu, 3dlu, pref, 3dlu, pref", "pref, 3dlu, pref, 3dlu, pref, 3dlu, pref, 3dlu, pref, 3dlu, pref, 3dlu, pref");
         final PanelBuilder pb = new PanelBuilder(fl, this);
         final CellConstraints cc = new CellConstraints();
         ...
         jButton_SubstrateMaterial.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
               final Composition comp = MaterialsCreator.editMaterial(getWizard(), mThread.mSubstrateMaterial, mSession, true);
               if(comp != null) {
                  final Material m = comp instanceof Material ? (Material) comp : new Material(comp, ToSI.gPerCC(5.0));
                  if(m.getDensity() < 1.0e-6) {
                     final NumberFormat df = new HalfUpFormat("0.0");
                     ErrorDialog.createErrorMessage(SimulationWizard.this, "Density too low!", "The density of the specified material is too low.", "The specified material has a density of "
                           + df.format(FromSI.gPerCC(m.getDensity())) + ".  This density is too low to simulate.");
                  } else {
         ...
         jButton_ObjectMaterial.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
               final Material m = (Material) MaterialsCreator.editMaterial(getWizard(), mThread.mObjectMaterial, mSession, true);
               if(m != null) {
                  if(m.getDensity() < 1.0e-6)
                     ErrorDialog.createErrorMessage(SimulationWizard.this, "Density too low!", "The density of the specified material is too low.", "The specified material has a density of "
                           + Double.toString(FromSI.gPerCC(m.getDensity())) + ".  This density is too low to simulate.");
                  else {
         ...
         jCheckBox_Overscan.setToolTipText("<HTML>Check this box to simulate rastering over the particle.<br/>Otherwise the beam will be placed at the center of the particle.");
