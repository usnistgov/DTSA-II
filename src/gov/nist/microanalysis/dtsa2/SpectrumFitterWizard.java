 ...
 * @version 1.0
 */
public class SpectrumFitterWizard extends JWizardDialog {
	...
	class IntroPanel extends JWizardPanel {
		...
		private void initialize() {
			final PanelBuilder pb = new PanelBuilder(new FormLayout("right:pref, 3dlu, 50dlu, 3dlu, 130dlu, 3dlu, pref",
					"pref, 5dlu, pref, 5dlu, pref, 5dlu, pref, 5dlu, pref, 5dlu, pref"), this);
	...
	class ElementPanel extends JWizardPanel {
	...
	public class OptionsPanel extends JWizardPanel {
		...
		private void initialize() {
			final PanelBuilder pb = new PanelBuilder(
					new FormLayout("right:pref, 10dlu, pref, 10dlu, pref, 3dlu, 20dlu, 3dlu, pref",
